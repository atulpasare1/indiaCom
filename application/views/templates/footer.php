      ...
      <div class="media m-75">
        <a href="JavaScript:void(0);">
          <div class="avatar mr-75">
            <img src="<?php echo base_url(); ?>assets/app-assets/images/portrait/small/avatar-s-2.jpg" alt="avtar images" width="32"
              height="32">
...
<!-- widget chat demo ends -->
    ...
    <script src="<?php echo base_url(); ?>assets/app-assets/vendors/js/extensions/swiper.min.js"></script>
    <!-- END: Page Vendor JS-->
