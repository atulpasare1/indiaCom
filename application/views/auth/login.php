...
<html class="loading" lang="en" data-textdirection="Arotalk">
...
<head>
    ...
    <meta name="author" content="India Commerece ">
    <title>Login Page </title>
    <link rel="apple-touch-icon" href="<?php echo base_url();?>assets/app-assets/images/ico/apple-icon-120.html">
    <link rel="shortcut icon" 
    type="image/x-icon" href="https://www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/app-assets/images/ico/favicon.ico">
        ...
        <div class="card bg-authentication mb-0">
            <div class="row m-0">
                ...
                <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                    <div class="card-content">
                        <img class="img-fluid" src="<?php echo base_url();?>assets/app-assets/images/pages/login.png" alt="branding logo">
                    </div>
                </div>
            </div>
        </div>
