...
<!-- Mirrored from www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/ltr/vertical-menu-template/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2019 11:57:54 GMT -->
<head>
        ...
        <div class="card bg-authentication mb-0">
            <div class="row m-0">
                ...
                <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                    <img class="img-fluid" src="<?php echo base_url(); ?>assets/app-assets/images/pages/register.png" alt="branding logo">
                </div>
            </div>
        </div>
    </div>
