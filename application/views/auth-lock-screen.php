        ...
        <div class="card bg-authentication mb-0">
            <div class="row m-0">
                ...
                <div class="col-md-6 col-12 px-0">
                    <div class="card disable-rounded-right mb-0 p-2">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="https://www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/ltr/vertical-menu-template/index.html">
                                    ...
                                    <button type="submit" class="btn btn-primary glow position-relative w-100">Unlock<i
                ...
                <div class="col-md-6 d-md-block d-none text-center align-self-center">
                    <img class="img-fluid" src="<?php echo base_url(); ?>assets/app-assets/images/pages/lock-screen.png" alt="branding logo"
                        width="350">
                </div>
            </div>
        </div>
...
<!-- Mirrored from www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/ltr/vertical-menu-template/auth-lock-screen.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2019 11:57:55 GMT -->
</html>